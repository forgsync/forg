...
export async function createCommit(repo: IRepo, workingTree: WorkingTreeFolder, parents: Hash[], message: string, author: Person, committer: Person = author): Promise<Hash> {
